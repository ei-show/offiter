  ...
  return (
    <Link href="/blogs/[id]" as={`blogs/${props.data.id}`}>
      <a className="mt-6 block">
        <div className="max-w-4xl p-1 bg-white rounded-lg border shadow-md lg:shadow-none lg:transition lg:duration-300 lg:ease-in-out lg:transform lg:hover:-translate-y-1 lg:hover:shadow-md">
