      ...
      <div className="mt-6">
        <div className="max-w-4xl px-10 py-6 bg-white rounded-lg shadow-md">
          <div className="flex justify-between items-center">
            ...
            <p href="#" className="px-2 py-1 bg-gray-600 text-gray-100 font-bold rounded hover:bg-gray-500">Laravel</p>
          </div>
          <div className="mt-2">
            <p href="#" className="text-2xl text-gray-700 font-bold hover:underline">{props.data.title}</p>
            <p className="mt-2 text-gray-600" dangerouslySetInnerHTML={{__html: `${props.data.body}`}}></p>
          </div>
          <div className="flex justify-between items-center mt-4">
            <p href="#" className="text-blue-500 hover:underline">Read more</p>
            <div>
